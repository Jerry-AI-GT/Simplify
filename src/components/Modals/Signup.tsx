...
const Signup: React.FC<SignupProps> = () => {
  ...
  return (
    <form className="space-y-6  px-6 lg:px-10 pb-4" onSubmit={handleRegister}>
      <h3 className="text-xl font-medium text-white">Register to Simplify</h3>
      <div>
        <label
          htmlFor="email"
        ...
        <input
          ...
          id="email"
          className="
        border-1 outline-none sm:text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5
